...
<p>This document is an up-to-date, authoritative specification
...
Standard 15836:2009 [<a href="#ISO15836">ISO15836</a>].</p>
...
<p>This release of DCMI Metadata Terms reflects changes described more fully in the
document "Maintenance changes to DCMI Metadata Terms" [<a
href="#REVISIONS">REVISIONS</a>].  Further information about change history
...
href="#TRANSLATIONS">TRANSLATIONS</a>].</p>
