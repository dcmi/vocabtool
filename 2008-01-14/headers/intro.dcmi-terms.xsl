...
RDF Schema versions of the DCMI term declarations
are available at [<a href="#RDFSCHEMAS">RDFSCHEMAS</a>].
...
A token assigned to the term, unique within the term's DCMI namespace.
</td></tr>
...
<tr><td width="20%">
<a name="RDFSCHEMAS"><xsl:text disable-output-escaping='yes'>&amp;nbsp;</xsl:text></a>[RDFSCHEMAS]
</td><td width="80%">
